...
var v = function (a, b) {
    var c = ja(ka, b);
    a.Ma ? m(void 0) ? c.call(void 0) : c() : (a.Ea || (a.Ea = []), a.Ea.push(m(void 0) ? q(c, void 0) : c))
};
...
var Da = function (a, b, c, d) {
    ...
    Ea = function (a, b, c) {
        p(a) || Da("Expected number but got %s: %s.", [da(a), a], b, Array.prototype.slice.call(arguments, 2));
        return a
    };
var Fa = function (a) {
    Fa[" "](a);
...
var eb = y("Opera"),
    z = cb(),
    fb = y("Edge"),
    A = y("Gecko") && !(-1 != $a.toLowerCase().indexOf("webkit") && !y("Edge")) && !(y("Trident") || y("MSIE")) && !y("Edge"),
        ...
        return Ha(a, function () {
            for (var b = 0, c = oa(String(ob)).split("."), d = oa(String(a)).split("."), e = Math.max(c.length, d.length), f = 0; 0 == b && f < e; f++) {
                ...
                do {
                    ...
                    b = za(0 == h[1].length ? 0 : parseInt(h[1], 10), 0 == l[1].length ? 0 : parseInt(l[1], 10)) || za(0 == h[2].length, 0 == l[2].length) || za(h[2], l[2]);
                    h = h[3];
                    l = l[3]
                } while (0 == b)
            }
...
E.prototype.kb = function (a, b) {
    ...
    null === d ? (this.offsetX = B || void 0 !== a.offsetX ? a.offsetX : a.layerX, this.offsetY = B || void 0 !== a.offsetY ? a.offsetY : a.layerY, this.clientX = void 0 !== a.clientX ? a.clientX :
...
Bb.prototype.add = function (a, b, c, d, e) {
    ...
    var h = Cb(a, b, d, e); - 1 < h ? (b = a[h], c || (b.zb = !1)) : (b = new zb(b, this.src, f, !!d, e), b.zb = c, a.push(b));
    return b
};
Bb.prototype.remove = function (a, b, c, d) {
    ...
    var e = this.F[a];
    b = Cb(e, b, c, d);
    return -1 < b ? (Ab(e[b]), w(null != e.length), Array.prototype.splice.call(e, b, 1), 0 == e.length && (delete this.F[a], this.ub--), !0) : !1
};
var Db = function (a, b) {
    var c = b.type;
...
var Eb = "closure_lm_" + (1E6 * Math.random() | 0),
    ...
    Pb = function (a, b, c, d, e) {
        ...
        else c = Ib(c), xb(a) ? a.Ja(b, c, d, e) : a && (a = Kb(a)) && (b = a.ib(b, c, !!d, e)) && Qb(b)
    },
    Qb = function (a) {
        if (!p(a) && a && !a.Sa) {
            var b = a.src;
            if (xb(b)) Db(b.U,
                ...
                var c = a.type,
                    d = a.Xb;
                b.removeEventListener ? b.removeEventListener(c, d, a.Za) : b.detachEvent && b.detachEvent(Mb(c), d);
                Gb--;
    ...
    Nb = function (a, b) {
        ...
        if (!sb) {
            ...
            if (!(0 > e.keyCode || void 0 != e.returnValue)) {
                ...
                for (h = 0; !c.Fa && h < e.length; h++) c.currentTarget = e[h],
                l = Sb(e[h], f, !1, c),
                d = d && l
            }
            return d
...
var Ub = y("Safari") && !((y("Chrome") || y("CriOS")) && !y("Edge") || y("Coast") || y("Opera") || y("Edge") || y("Silk") || y("Android")) && !(db() || y("iPad") || y("iPod"));
var Vb = hb && Ub && !C(536.25),
    ...
    Xb = function (a) {
        ...
        }), Wb(b, a + ".ogg", "audio/ogg"), Wb(b, a + ".mp3", "audio/mpeg")) : b = null;
        return b
    };
...
g.load = function (a) {
    var b;
    a && (b = this.ga[a], !b && (b = Xb(this.Cd + "/" + a))) && (this.Zd.appendChild(b), this.ga[a] = b);
    return b
};
g.loop = function (a) {
...
var ac = function (a, b, c, d, e, f) {
    if (ea(c))
        for (var h = 0; h < c.length; h++) ac(a, b, c[h], d, e, f);
    else {
...
F.prototype.Ja = function (a, b, c, d, e) {
    ...
    else c = c || this.handleEvent, e = e || this.B || this, c = Ib(c), d = !!d, b = xb(a) ? a.ib(b, c, d, e) : a ? (a = Kb(a)) ? a.ib(b, c, d, e) : null : null, b && (Qb(b), delete this.i[b.key]);
    return this
};
...
g.dispatchEvent = function (a) {
    ...
    var e = !0,
        f;
    if (b)
        for (var h = b.length - 1; !a.Fa && 0 <= h; h--) f = a.currentTarget = b[h], e = cc(f, d, !0, a) && e;
    a.Fa || (f = a.currentTarget = c, e = cc(f, d, !0, a) && e, a.Fa || (e = cc(f, d, !1, a) && e));
    if (b)
...
var bc = function (a) {
    w(a.U, "Event target is not initialized. Did you call the superclass (goog.events.EventTarget) constructor?")
};
var dc = function (a) {
    G.call(this);
    this.K = a;
...
dc.prototype.kb = function () {
    this.Xc || (this.Xc = !0, Ua(ec, function (a) {
...
g.translate = function (a, b) {
    a instanceof I ? (this.x += a.x, this.y += a.y) : (this.x += Number(a), p(b) && (this.y += b));
    return this
};
...
g.contains = function (a) {
    return this && a ? a instanceof qc ? a.left >= this.left && a.right <= this.right && a.top >= this.top && a.bottom <= this.bottom : a.x >= this.left && a.x <= this.right && a.y >= this.top && a.y <= this.bottom : !1
};
g.floor = function () {
...
g.translate = function (a, b) {
    a instanceof I ? (this.left += a.x, this.right += a.x, this.top += a.y, this.bottom += a.y) : (Ea(a), this.left += a, this.right += a, p(b) && (this.top += b, this.bottom += b));
    return this
};
g.scale = function (a, b) {
    var c = p(b) ? b : a;
...
g.translate = function (a, b) {
    a instanceof I ? (this.left += a.x, this.top += a.y) : (this.left += Ea(a), p(b) && (this.top += b));
    return this
};
g.scale = function (a, b) {
    var c = p(b) ? b : a;
...
var vc = function (a) {
    ...
    Ac = function (a) {
        ...
        return z && C("10") && a.pageYOffset != b.scrollTop ? new I(b.scrollLeft, b.scrollTop) : new I(a.pageXOffset || b.scrollLeft, a.pageYOffset || b.scrollTop)
    },
    Cc = function (a, b, c) {
        function d(c) {
...
g.lc = function (a, b) {
    var c = b || this.D,
        d = c || document;
    return (d.getElementsByClassName ? d.getElementsByClassName(a)[0] : d.querySelectorAll && d.querySelector ? d.querySelector("." + a) : xc("*", a, c)[0]) || null
};
g.w = function (a, b, c) {
    var d = this.D,
        e = arguments,
...
var Hc = function (a, b, c) {
    ...
    Gc = function (a, b) {
        ...
        if (!c) {
            var d = Aa(b),
                c = d;
            void 0 === a.style[d] && (d = (B ? "Webkit" : A ? "Moz" : z ? "ms" : eb ? "O" : null) + Ba(d), void 0 !== a.style[d] && (c = d));
            Ic[b] = c
        }
        return c
    },
...
var M = function (a, b, c) {
        ...
        b.I && a.I && b.getParent() == a ? (a = a.h, d = a.childNodes[d] || null, d != b.b() &&
            a.insertBefore(b.b(), d)) : c ? (a.h || a.w(), d = a.H ? a.H[d + 1] || null : null, Vc(b, a.h, d ? d.h : null)) : a.I && !b.I && b.h && b.h.parentNode && 1 == b.h.parentNode.nodeType && b.A()
    },
    Xc = function (a, b) {
        a.H && x(a.H, b, void 0)
    };
...
var N = function (a, b, c) {
    ...
    this.Z = new F(this);
    v(this, this.Z);
    this.deltaY = this.deltaX = this.td = this.sd = this.screenY = this.screenX = this.clientY = this.clientX = 0;
    this.sa = !0;
    this.ra = !1;
    this.fd = !0;
    this.Uc = 0;
...
N.prototype.bc = function (a) {
    ...
    if (!this.sa || this.ra || b && (!(rb ? 0 == a.ja.button : "click" == a.type || a.ja.button & vb[0]) || B && gb && a.ctrlKey)) this.dispatchEvent("earlycancel");
    else {
        if (0 == this.Uc)
            if (this.dispatchEvent(new bd("start", this, a.clientX, a.clientY))) this.ra = !0, this.fd && b && a.preventDefault();
            else return;
...
N.prototype.Ba = function (a, b) {
    this.Z.Ra();
    Zc && this.D.releaseCapture();
    this.ra ? (this.ra = !1, this.dispatchEvent(new bd("end", this, a.clientX, a.clientY, 0, cd(this, this.deltaX), dd(this, this.deltaY), b || "touchcancel" == a.type))) : this.dispatchEvent("earlycancel")
};
N.prototype.Fd = function (a) {
    if (this.sa) {
        ...
        b = c.x;
        c = c.y;
        this.ra && this.dispatchEvent(new bd("beforedrag", this, a.clientX, a.clientY,
            0, b, c)) && (fd(this, a, b, c), a.preventDefault())
    }
};
...
t(bd, D);
var gd = "StopIteration" in k ? k.StopIteration : {
...
g.remove = function (a) {
    return kd(this.W, a) ? (delete this.W[a], this.o--, this.vb++, this.i.length > 2 * this.o && jd(this), !0) : !1
};
var jd = function (a) {
    if (a.o != a.i.length) {
    ...
    if (a.o != a.i.length) {
        for (var e = {}, c = b = 0; b < a.i.length;) d = a.i[b], kd(e, d) || (a.i[c++] = d, e[d] = 1), b++;
        a.i.length = c
    }
};
g = id.prototype;
...
var nd = function (a, b) {
    ...
    this.P = this.Jd = !1;
    var c;
    if (a instanceof nd) this.P = m(b) ? b : a.P, od(this, a.Ta), c = a.dc, O(this), this.dc = c, c = a.eb, O(this), this.eb = c, pd(this, a.Vb), c = a.Ub, O(this), this.Ub = c, qd(this, a.Ga.clone()), c = a.Fb, O(this), this.Fb = c;
...
nd.prototype.toString = function () {
    ...
    b && a.push(td(b, ud, !0), ":");
    var c = this.eb;
    if (c || "file" == b) a.push("//"), (b = this.dc) && a.push(td(b, ud, !0), "@"), a.push(encodeURIComponent(String(c)).replace(/%25([0-9a-fA-F]{2})/g, "%$1")), c = this.Vb, null != c && a.push(":", String(c));
    if (c = this.Ub) this.eb && "/" != c.charAt(0) && a.push("/"), a.push(td(c, "/" == c.charAt(0) ? vd : wd, !0));
...
var od = function (a, b, c) {
    ...
    qd = function (a, b, c) {
        O(a);
        b instanceof sd ? (a.Ga = b, a.Ga.Fc(a.P)) : (c || (b = td(b, yd)), a.Ga = new sd(b, 0, a.P))
    },
    O = function (a) {
...
var rd = function (a, b) {
    ...
    td = function (a, b, c) {
        return n(a) ? (a = encodeURI(a).replace(b, zd), c && (a = a.replace(/%25([0-9a-fA-F]{2})/g, "%$1")), a) : null
    },
    zd = function (a) {
        a = a.charCodeAt(0);
    ...
    Ad = function (a) {
        a.m || (a.m = new id, a.o = 0, a.J && md(a.J, function (b, c) {
...
g.remove = function (a) {
    Ad(this);
    a = Bd(this, a);
    return this.m.bb(a) ? (this.J = null, this.o = Ea(this.o) - this.m.get(a).length, this.m.remove(a)) : !1
};
g.clear = function () {
    this.m = this.J = null;
    this.o = 0
...
sd.prototype.Fc = function (a) {
    a && !this.P && (Ad(this), this.J = null, this.m.forEach(function (a, c) {
        var b = c.toLowerCase();
        c != b && (this.remove(c), this.remove(b), 0 < a.length && (this.J = null, this.m.set(Bd(this, b), Qa(a)), this.o = Ea(this.o) + a.length))
    }, this));
    this.P = a
};
var Dd = function (a) {
...
var Jd = function (a) {
    ...
    Ld = function (a, b) {
        a.classList ? a.classList.add(b) : Kd(a, b) || (a.className += 0 < a.className.length ? " " + b : b)
    },
    Md = function (a, b) {
        a.classList ? a.classList.remove(b) : Kd(a, b) && (a.className = Ja(Jd(a), function (a) {
            return a != b
        }).join(" "))
    },
    Nd = function (a, b) {
...
var Qd = function (a) {
        ...
        Pd[c] = b; - 1 != a.search("&ei=") || (d = "&ei=");
        a = "/gen_204?atyp=i&ct=doodle&cad=" + a + d + "&zx=" + r();
        /^http:/i.test(a) && "https:" == window.location.protocol ? delete Pd[c] : (b.src = a, Od = c + 1)
    },
    Pd = [],
    Od = 0;
var Rd, Sd = navigator.userAgent,
    Td = -1 != Sd.indexOf("iPad") || -1 != Sd.indexOf("iPhone") || -1 != Sd.indexOf("iPod") || -1 != Sd.indexOf("Android") || -1 != Sd.indexOf("Mobile") || -1 != Sd.indexOf("Silk"),
    ...
    Wd = function (a, b) {
        for (var c = 1; c < arguments.length; c += 2) {
            var d = arguments[c],
                e = arguments[c + 1],
                f = a.style;
            f && d in f ? f[d] = e : d in a ? a[d] = e : Ud && f && "opacity" == d && (a.zoom = 1, d = (f.filter || "").replace(/alpha\([^)]*\)/, ""), isNaN(parseFloat(e)) || (d += "alpha(opacity=" + 100 * e + ")"),
                f.filter = d)
        }
    },
    Xd = function (a) {
        if (window.google && window.google.log) {
            var b;
            Rd || (b = document.getElementById("hplogoved")) && (Rd = b.getAttribute("data-ved"));
            (b = Rd) && (a += "&ved=" + b);
...
var Yd = function (a, b, c, d, e) {
    ...
    this.ae = c;
    this.Id = d;
    e && (this.xb && this.Ja(this.xb, "action", this.Nc), e && (this.xb = new Dd(e), v(this, this.xb), this.Nc = q(this.show, this), this.a(this.xb, "action", this.Nc)))
};
t(Yd, F);
Yd.prototype.show = function () {
    Zd() && !cb() && window.gapi && window.gapi.load ? (window.gapi.load("share", q(this.Tc, this)), Xd("gplus,li")) : (window.open("https://plus.google.com/share?url=" + this.od), Xd("gplus,lo"))
};
var Zd = function () {
...
g.ia = function (a, b, c, d, e, f, h, l) {
    ...
    b.translate(c, d);
    b.scale(h ? -e : e, l ? -e : e);
    this.drawImage(b, a, 0, 0, P, jb, -P * (f ? .5 : h ? 1 : 0), -jb * (f ? .5 : l ? 1 : 0), P, jb);
    b.restore()
};
var he = function (a, b) {
    var c;
    ...
    Wd(c, "userSelect", "none", "MozUserSelect", "none", "webkitUserSelect", "none", "webkitTapHighlightColor", "rgba(0,0,0,0)");
    c.unselectable = "on";
    var d = a.Da(b),
        e = a.gb(b),
        f = b[5] || 1;
    ...
    e = a.oc[ge(b)];
    f = b[5] || 1;
    c = [c, "url(" + a.jb[ge(b)].Mc + ") " + (-(b[1] / f + 0) + "px " + -(b[2] /
...
var ie = [{
    ...
    qe = [0, 1575, 198, 96, 96];
ca(je);
var re = [[0, 1402, 308, 50, 50], [0, 925, 239, 50, 50], [0, 766, 292, 50, 50], [0, 872, 292, 50, 50], [0, 978, 292, 50, 50], [0, 1628, 297, 50, 50], [0, 1084, 308, 50, 50], [0, 1190, 308, 50, 50], [0, 1296, 308, 50, 50], [0, 819, 239, 50, 50], [0, 816, 345, 50, 50], [0, 922, 345, 50, 50], [0, 869, 345, 50, 50]],
    se = [[0, 1349, 308, 50, 50], [0, 872, 239, 50, 50], [0, 978, 239, 50, 50], [0, 819, 292, 50, 50], [0, 925, 292, 50, 50], [0, 1575, 297, 50, 50], [0, 1031, 308, 50, 50], [0, 1137, 308, 50, 50], [0, 1243, 308, 50, 50], [0, 766, 239, 50, 50], [0, 1455, 308, 50, 50], [0, 604, 317, 50, 50], [0, 1508, 308, 50, 50]],
    te = {
        CLUB: [0,
0, 239, 148, 141],
    ...
    Ce = function () {
        var a;
        a = $d("www.google.com/search?q=solitaire");
        var b = new nd("http://www.facebook.com/sharer.php"),
            c = new sd;
        c.add("u", a);
        qd(b, c);
    ...
    De = function () {
        var a, b = Q("Share message");
        a = $d("www.google.com/search?q=solitaire");
        window.open("http://twitter.com/intent/tweet?status=" + encodeURIComponent(String(b + "\n" + a)));
        Xd("share,3,x")
    },
    Ee = function () {
        window.google.doodle.alt = Q("Share message.");
        var a, b = Q("Share message");
        a = $d("www.google.com/search?q=solitaire");
        (new Yd(a, window.google.doodle.alt || "", b, "//www.gstatic.com/lrfactory/solitaire/cta_2x.png")).show()
    },
    Fe = function () {
        return ae() || 589824 < window.innerHeight * window.innerWidth
    },
    Q = function (a) {
        var b = window.google.doodle;
        return b ?
            (b = b.msgs) && b[a] ? b[a] : "" : ""
    },
    R = Math.round(ye().width * (Fe() ? .33 : .22)),
    S = Math.round(ye().height * (Fe() ? .33 : .22));
ye();
ye();
var Ge = Math.round(.3 * S),
    He = Math.round(.3 * S);
var T = function (a, b) {
    N.call(this, a.b());
    this.oa = a;
    ...
    this.gd = "";
    this.xa = 1;
    if (this.nb = b) this.Ob = new J(this.nb.left * this.xa, this.nb.top * this.xa, this.nb.width * this.xa, this.nb.height * this.xa);
    this.Wc = this.Vc = 0;
    this.da(a)
};
t(T, N);
...
T.prototype.Ba = function (a, b) {
    ...
    1 > Math.abs(this.Vc - this.deltaX) + Math.abs(this.Wc - this.deltaY) ? T.g.Ba.call(this, a, !0) : T.g.Ba.call(this, a, b)
};
var Je = function (a) {
    a.j().rc(a.oa.b(), ["click", "touchend"], function (a) {
        a.stopPropagation()
    }, !0)
};
...
g.Rb = function () {
    ...
    if (a) {
        ...
        if (a.ka) {
            ...
            this.wa.ia(c, 105, 12);
            11 <= b.R && 13 >= b.R ? (c = b.R, this.wa.ia("RED" == oc(b) ? ve[c] : we[c], 0, 84)) : this.wa.ia(te[b.S], 15, 93)
        } else this.wa.ia(ke, 2, 3);
        a.Ib && (a = this.wa, b = a.pd.mc(ke), a.cb.lineWidth = 5, a.cb.strokeStyle = "#FFD700", a.cb.strokeRect(2, 3, b.width, b.height));
...
var Se = function (a) {
    if (a.empty()) {
        ...
        a.push(b);
        a.dispatchEvent("x")
    } else b = a.G.Pb, a.size() < b && (b = a.size()), b = a.pop(b), a.N.push(b), a.dispatchEvent("v")
};
...
Te.prototype.Nd = function (a) {
    if (!a.Ed && !a.defaultPrevented) {
        ...
        }, this) || this.dispatchEvent(new D("i", a.Cb))
    }
};
var Ue = function (a) {
...
g.ce = function () {
    if (this.enabled) {
        var a = r() - this.qc;
        0 < a && a < .8 * this.Lb ? this.M = this.Ua.setTimeout(this.fc, this.Lb - a) : (this.M && (this.Ua.clearTimeout(this.M), this.M = null), this.dispatchEvent("tick"), this.enabled && (this.M = this.Ua.setTimeout(this.fc, this.Lb), this.qc = r()))
    }
};
g.start = function () {
    this.enabled = !0;
...
var X = function (a, b, c, d, e) {
        ...
        return new J(b * (a.Nb + f) + a.qb, c * (a.Mb + h) + a.Bc, d * a.Nb + (d - 1) * f, e * a.Mb + (e - 1) * h)
    },
    ef = function (a) {
        a.top = 48 + S;
        return a
...
ff.prototype.log = function (a, b, c) {
    ...
    Xd(["solitaire", "a:" + a, "ez:" + gf(b), "cs:" + (c || 0), "dt:" + e, "t:" + gf(Td), "w:" + gf(d.width > d.height), "o:" + ("orientation" in window ? parseInt(window.orientation, 10) : "_")].join())
};
var gf = function (a) {
    return m(a) ? a ? "1" : "0" : "_"
};
...
g.A = function () {
    ...
    this.j().a(this.$b, "click", Ee);
    this.j().a(this.Zb, "click", Ce);
    this.j().a(this.ac, "click", De);
    this.nc()
};
g.nc = function () {
...
g.openDialog = function (a, b) {
    ...
    a && !b ? Fc(this.Jb, Q("After winning the game: play again?")) : a ? Fc(this.Jb, Q("Mode selection")) : Fc(this.Jb, Q("Confirm dialog: to start a new game?"))
};
g.$a = function () {
    K(this.b(), !1)
};
...
Y.prototype.Rb = function () {
    ...
    if (0 != a.length) {
        ...
        x(a, function (a, f) {
            ...
            a.fb && (c += Math.min(Ge, Math.floor(mf(a) / b * (this.O - R))), d += Math.min(He, Math.floor(mf(a) / b * (this.L - S))))
        }, this)
    }
};
var nf = function (a, b) {
...
t( of , L);
g = of .prototype;
g.v = function (a) { of .g.v.call(this, a);
...
W.prototype.accept = function (a) {
    ...
    b.pop(1 + c.length);
    this.push(Pa(a, c));
    b instanceof W ? this.dispatchEvent("A") : b instanceof Qe ? this.dispatchEvent("C") : b instanceof V && this.dispatchEvent("w")
};
...
pf.prototype.Wd = function () {
    (this.Lc = !this.Lc) ? (this.Kc.style.display = "inline-block", this.Jc.style.display = "none", this.dispatchEvent("r")) : (this.Kc.style.display = "none", this.Jc.style.display = "inline-block", this.dispatchEvent("s"))
};
pf.prototype.Ld = function () {
    for (var a = window; a.postMessage("lightbox-exit", "*"), a !== a.parent;) a = a.parent
};
var qf = function (a) {
    "Easy" == a.sc ? (a.Na.style.display = "inline", a.Pa.style.display = "none") : (a.Na.style.display = "none", a.Pa.style.display = "inline")
};
var rf = function (a) {
    L.call(this, a);
...
var wf = function (a) {
    ...
    Af = function (a, b) {
        ...
        a.Ca = [];
        x(a.V, function (a, b) {
            var d = new Y(a, new J(c.Da() - c.qb - R, 16 * (.5 * b + 1) + b * S, R, S));
            lf(d, .2);
            this.Ca.push(d)
        }, a)
    },
    ...
    Cf = function (a, b) {
        ...
        x(a.Ca, function (a, b) {
            a.moveTo(new J(c.Da() - c.qb - R, 16 * (.5 * b + 1) + b * S, R, S))
        }, a);
        Bf(a, c)
    },
    Df = function (a, b) {
...
Z.prototype.A = function () {
    ...
    be() || ae() ? (a.a(this, "o", this.cd), a.a(this, "f", this.$c)) : (a.a(this, "m", this.cd), a.a(this, "d", this.$c));
    ...
    var b = a = this.Sb;
    this && (b = q(a, this));
    "function" != da(k.setImmediate) || k.Window && k.Window.prototype && !y("Edge") && k.Window.prototype.setImmediate == k.setImmediate ? (af || (af = bf()), af(b)) : k.setImmediate(b)
};
var Ff = function (a) {
    var b = a.j();
    x(a.fa, function (a, d) {
...
g.Hc = function () {
    var a = this.ua.Hc();
    a && (We(a, "deck", this.ha), We(a, "waste", this.N), x(this.V, function (b, c) {
        We(a, "foundation" + c, b)
    }), x(this.fa, function (b, c) {
        We(a, "tableau" + c, b)
    }), this.$.Yb(a.u), Ye(a, this.f));
    Nd(this.ca.Wa, !(1 < this.ua.ea.length))
};
g.kd = function () {
    this.ua.clear();
...
g.Pd = function (a) {
    ...
    var b = a.oa,
        c = b.C.s;
    c instanceof W ? Ie(a, Ka(Ne(c, b.C), function (a) {
        return a.Xa
    })) : Ie(a, []);
    return !0
};
...
g.$c = function (a) {
    a = a.target.C;
    var b = a.s;
    b instanceof Qe || b instanceof V ? a.tb && ic(b, "g", a) : b instanceof W ? a.ka && this.G.ic && ic(b, "g", a) : b instanceof Re && Se(b)
};
g.cd = function (a) {
    a = a.target.s;
...
g.Qd = function () {
    if (this.mb) {
        ...
        for (var a = !1; !a;) a = !0, x(this.f, function (b) {
            mc(b, !0);
            x(this.V, function (a) {
                a.Ka(b) && a.push(b)
            }, this);
            ...
            if (a) {
                ...
                if (b) {
                    ...
                    if (c) {
                        ...
                        d && (K(b, !0), K(c, !1), K(d, !1), je.la().Wb(0, function () {
                            a.style.display = "block";
                            Kf = new Z;
                            var c = window.google.doodle;
                            if (c.allMsgs) {
                                var d = /[&=]?hl=([^&]*)/.exec(window.location.hash || window.location.search),
                                    d = d ? d[1] : "en",
                                    d = d.replace("_", "-");
                                c.allMsgs.translations[d] || (d = "en");
                                c.hl =
                                    d;
                                c.msgs = {};
                                for (var h = 0; h < c.allMsgs.messages.length; ++h) c.msgs[c.allMsgs.messages[h]] = c.allMsgs.translations[d].ALL[h];
                                document.title = c.msgs["Game title"]
                            }
                            Wc(Kf, a);
                            Jf.kb();
                            Jf.log(1);
